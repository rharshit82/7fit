...
const ChallengeYourFriend = () => {
    ...
    return (
        ...
        <div>
        <div>
            <h2 className="text-center mt-5">Challenge your Friend Today !!</h2>
            <h3 className="text-center my-4">Exercising with a friend or loved one can make it more fun, and increase your chances of sticking to your exercise plan.</h3>
        </div>
        <div className="my-5">
            <h4 className="text-center"> Click on the challenge to send it to your friend with Twilio API</h4>
        ...
        {message.length>0?
        (<div >
            <h4 style={{border: "2px solid black", backgroundColor: "#D1E7DD"}} className="text-center w-75 mx-auto p-4 font-weight-bold">Selected Message: {message}</h4>
