...
const WorkoutMotivation = () => {
    return (
        <div className="my-4">
            <h2 className="text-center">Workout Motivation</h2>
            <h3 className="text-center">Today I will do what others won't, so tomorrow I can accomplish what others can't</h3>
            ...
            <div className="my-3">
                <h2 className="text-center">Workout videos</h2>
